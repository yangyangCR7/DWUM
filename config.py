...
__C.TRAIN.NUM_POSITIVE_SAMPLES = 3

__C.TRAIN.BATCH_SIZE = 100

__C.TRAIN.NUM_PER_CLASS = 3

__C.TRAIN.NUM_SAMPLED_CLASSES = 27
...
# ---------------------------------------------------------------------------- #
__C.LOSS = AttrDict()
__C.LOSS.METRIC_LOSS = 'Proxy_Anchor'

__C.LOSS.PROXY_LR = 100
__C.LOSS.ALPHA = 32.0
__C.LOSS.MRG = 0.1

__C.LOSS.MS_SCALE_POS = 2.0
__C.LOSS.MS_SCALE_NEG = 40.0
__C.LOSS.MS_MARGIN = 0.1

__C.LOSS.NCA_SCALE = 3.0

__C.LOSS.SOFT_TRIPLE_LA = 20.0
__C.LOSS.SOFT_TRIPLE_GAMMA = 0.1
__C.LOSS.SOFT_TRIPLE_TAU = 0.2
__C.LOSS.SOFT_TRIPLE_MARGIN = 0.01
__C.LOSS.SOFT_TRIPLE_K = 10    

__C.LOSS.BETA = 1e-5

__C.LOSS.NOISE_RATE = 0.5
__C.LOSS.WARMUP_EPOCHS = 2
__C.LOSS.GAMMA = 0.3

__C.LOSS.LAMBDA_DIM = 0.1
__C.LOSS.LAMBDA_DCL = 0.5
__C.LOSS.LAMBDA_VAR = 1.0
__C.LOSS.TAU_DCL = 0.07
# ---------------------------------------------------------------------------- #
# Solver options
...
__C.SOLVER.METRIC_TYPE = 'Adam'

__C.SOLVER.GEN_TYPE = 'Adam'
